...
type Employee struct {
	...
	BornDate              primitive.DateTime  `json:"bornDate,omitempty" bson:"bornDate,omitempty" binding:"required"`
	Rg                    string              `json:"rg,omitempty" bson:"rg,omitempty" binding:"required"`
	RgExpiration          primitive.DateTime  `json:"rgExpiration,omitempty" bson:"rgExpiration,omitempty" binding:"required"`
	RgExpedition          primitive.DateTime  `json:"rgExpedition,omitempty" bson:"rgExpedition,omitempty" binding:"required"`
	...
	CnhExpiration         *primitive.DateTime `json:"cnhExpiration,omitempty" bson:"cnhExpiration,omitempty"`
	...
	AdmissionDate         *primitive.DateTime `json:"admissionDate,omitempty" bson:"admissionDate,omitempty"`
